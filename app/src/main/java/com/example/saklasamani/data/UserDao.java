...
public class UserDao {
    ...
    public boolean decreaseBudget(String userName, double amount) {
        SQLiteDatabase db = dbHelper.getWritableDatabase();

        Cursor cursor = db.query("user", new String[]{"budget"}, "userName = ?",
    ...
    public boolean increaseBudget(String userName, double amount) {
        SQLiteDatabase db = dbHelper.getWritableDatabase();
